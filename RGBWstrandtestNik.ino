...
void loop() {
  ...
  colorBucket(strip.Color(255,   0,   0)     , STEPDELAY); // Red
  colorBucket(strip.Color(  0, 255,   0)     , STEPDELAY); // Green
  ...
  colorWipe(strip.Color(  0,   0,   0, 255), STEPDELAY); // True white (not RGB white)
...
void colorBucket(uint32_t color, int wait) {
